...
const links = [
  ...
  ["Instruments", "/admin/instruments", Scale],
  ["Certificates", "/admin/certificates", FileCheck2],
  ["Users", "/admin/users", Users],
  ["Audit Trail", "/admin/audit-trail", ScrollText],
...
export default function AdminSidebar({ open, onClose }) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed left-0 top-0 z-50 flex h-screen w-64 flex-col bg-[#1e1b4b] text-white transition-transform duration-300 lg:translate-x-0 ${
